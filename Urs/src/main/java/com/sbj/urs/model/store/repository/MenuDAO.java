...
public interface MenuDAO {
   ...
   public String selectByImage(int menu_id); // 메뉴id로 메뉴 이미지 불러오기
   public void insert(Menu menu); //메뉴 생성 
   public void update(Menu menu); // 메뉴수정 
   public void updates(Menu menu); // 메뉴수정 
   public void delete(int menu_id); //메뉴삭제
