...
import com.sbj.urs.exceptoion.MailSendException;
@Component
public class MailSender {
	...
	public void send(String to,String title,String content) throws MailSendException {
		...
		try {
			...
			message.setContent("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><!--[if IE]><html xmlns=\"http://www.w3.org/1999/xhtml\" class=\"ie\"><![endif]--><!--[if !IE]><!--><html style=\"margin: 0;padding: 0;\" xmlns=\"http://www.w3.org/1999/xhtml\"><!--<![endif]--><head>\r\n"
					...
					+ "      </div>\r\n"
					+ "      <div>\r\n"
					+ "      <div style=\"background-color: #4b5462;background: 0px 0px/auto auto repeat url(https://www.gardenhotels.co.jp/images/shiodome-italiagai/breakfast/sandwich.jpg) #4b5462;background-position: 0px 0px;background-image: url(https://www.gardenhotels.co.jp/images/shiodome-italiagai/breakfast/sandwich.jpg);background-repeat: repeat;background-size: auto auto;\">\r\n"
					...
					+ "        <h1 class=\"size-64\" style=\"mso-text-raise: 25px;Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #000;font-size: 44px;line-height: 50px;font-family: avenir,sans-serif;text-align: center;\" lang=\"x-size-64\"><span class=\"font-avenir\"><strong><span style=\"color:#ffffff\">Welcome to URS website!</span></strong></span></h1>\r\n"
					+ "      </div>\r\n"
					+ "    </div>\r\n"
					+ "            \r\n"
					+ "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n"
					...
					+ "          <img style=\"border: 0;display: block;height: auto;width: 100%;max-width: 450px;\" alt=\"Scuba diving\" width=\"260\" src=\"https://i.imgur.com/oQjhwOz.jpg\" />\r\n"
					+ "        </div>\r\n"
					+ "      </div>\r\n"
					+ "            \r\n"
					+ "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n"
					+ "      <div style=\"mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;\">\r\n"
					+ "        <h3 style=\"Margin-top: 0;Margin-bottom: 12px;font-style: normal;font-weight: normal;color: #281557;font-size: 18px;line-height: 26px;font-family: Avenir,sans-serif;\"><strong>한식</strong></h3>\r\n"
					+ "      </div>\r\n"
					+ "    </div>\r\n"
					+ "            \r\n"
					+ "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n"
					...
					+ "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n"
					+ "        <div style=\"font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;Margin-bottom: 20px;\" align=\"center\">\r\n"
					+ "          <img style=\"border: 0;display: block;height: auto;width: 100%;max-width: 450px;\" alt=\"Plane in flight\" width=\"260\" src=\"https://i.imgur.com/gbYC0OC.jpg\" />\r\n"
					+ "        </div>\r\n"
					+ "      </div>\r\n"
					+ "            \r\n"
					+ "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n"
					+ "      <div style=\"mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;\">\r\n"
					+ "        <h3 style=\"Margin-top: 0;Margin-bottom: 12px;font-style: normal;font-weight: normal;color: #281557;font-size: 18px;line-height: 26px;font-family: Avenir,sans-serif;\"><strong>일식</strong></h3>\r\n"
					+ "      </div>\r\n"
					+ "    </div>\r\n"
					+ "            \r\n"
					+ "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n"
	...
	public void send(String to, String title, String content,String new_pw) throws MailSendException{
		props.put("mail.smtp.host", host);
		props.put("mail.smtp.port", 465);
		props.put("mail.smtp.auth", "true");
		props.put("mail.smtp.ssl.enable", "true");
		...
		try {
			...
			message.setContent("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><!--[if IE]><html xmlns=\"http://www.w3.org/1999/xhtml\" class=\"ie\"><![endif]--><!--[if !IE]><!--><html style=\"margin: 0;padding: 0;\" xmlns=\"http://www.w3.org/1999/xhtml\"><!--<![endif]--><head>\r\n"
					...
					+ "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n"
					+ "      <div style=\"mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;\">\r\n"
					+ "        <h1 class=\"size-64\" style=\"mso-text-raise: 25px;Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #000;font-size: 44px;line-height: 50px;font-family: avenir,sans-serif;text-align: center;\" lang=\"x-size-64\"><span class=\"font-avenir\"><strong><span style=\"color:#ffffff\">비밀번호 초기화</span></strong></span></h1>\r\n"
					+ "      </div>\r\n"
					+ "    </div>\r\n"
					+ "            \r\n"
					+ "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n"
					...
					+ "            <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n"
					+ "      <div style=\"mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;\">\r\n"
					+ "        <h2 style=\"Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #e31212;font-size: 26px;line-height: 34px;font-family: Avenir,sans-serif;text-align: center;\"><strong>요청하신 임시 비밀번호입니다.</strong></h2>\r\n"
					+ "      </div>\r\n"
					+ "    </div>\r\n"
					+ "        \r\n"
					+ "          </div>\r\n"
					...
					+ "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n"
					+ "      <div style=\"mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;\">\r\n"
					+ "        <h3 style=\"Margin-top: 0;Margin-bottom: 12px;font-style: normal;font-weight: normal;color: #281557;font-size: 18px;line-height: 26px;font-family: Avenir,sans-serif;\"><strong>임시 비밀번호 :"+new_pw+" </strong></h3>\r\n"
					+ "      </div>\r\n"
					+ "    </div>\r\n"
					+ "            \r\n"
					+ "              <div style=\"Margin-left: 20px;Margin-right: 20px;\">\r\n"
					+ "      <div style=\"mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;\">\r\n"
					+ "        <p style=\"Margin-top: 0;Margin-bottom: 20px;\">로그인 후 꼭 비밀번호 변경 부탁드립니다.</p>\r\n"
					+ "      </div>\r\n"
					+ "    </div>\r\n"
					+ "            \r\n"
					+ "             \r\n"
