...
<script>
   function remove() {
      $("#paymentForm").attr({
         action:"/admin/payment/paymentdetaildelete",
         method:"post"
      });      
      $("#paymentForm").submit();
   }
  ...
  <div style="background-color:#ffffff">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">'<%=member.getUser_name()%>'님의 결제 상세 정보</h2>
                    <form id="paymentForm">
                ...
                <div class="p-t-15">
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp;   
                    <button class="btn btn-primary" mdbWavesEffect type="button" style="width:16rem" onClick="location.href='/admin/payment/paymentlist';">결제 리스트 목록</button>
               </div>
             </form>
         </div>
      </div>
