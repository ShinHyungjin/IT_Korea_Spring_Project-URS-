                    ...
                    <form id="menuForm">
                        ...
                        <div class="row row-space">
                            <div class="col-8">
                              <div style="text-align: center" height="300px">
                                     <img alt="menu_image" id="menu_image" src="/resources/data/menu/<%=menu.getMenu_image()%>"  width="250px">
                                  </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-space">
                           ...
                           <div class="custom-file">
                                <input type="file" name="menu_image" class="custom-file-input" id="menu_image" onchange="readURL(this,0)">
